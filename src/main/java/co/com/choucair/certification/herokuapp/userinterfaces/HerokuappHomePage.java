...
public class HerokuappHomePage extends PageObject {
    ...
    public static final Target BOTON_AGENDAR_CITA= Target.the("boton para entrar al formulario de agregar cita").located(By.xpath("//a[contains(text(),'Agendar Cita')]"));
}
